 ...
 *
 * Disassembly of SSDT9.aml, Thu May  6 01:10:51 2021
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "HdaDsp", 0x00000000)
{
    ...
    Scope (\_SB.PCI0.HDAS)
    {
        ...
        {
            If (LEqual (Arg0, ToUUID ("7111001f-d35f-44d9-81d2-7ac685bed3d7") /* Unknown UUID */))
            {
            ...
            If (LEqual (Arg0, ToUUID ("849f0d73-1678-4d57-8c78-61c548253993") /* Unknown UUID */))
            {
