 ...
 *
 * Disassembly of DSDT.aml, Sun May  2 11:05:07 2021
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS4, One)
    One
    OperationRegion (GNVS, SystemMemory, 0x7B558000, 0x0792)
    ...
    OperationRegion (MNVS, SystemMemory, 0x7B568018, 0x1000)
